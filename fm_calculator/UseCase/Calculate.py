...
import Interactor.open_display_list_of_actions
            ...
            if owner_id in vertical_accounts.keys():
                ...
                for p in range(period + 1):
                        ...
                        if element in accounts:
                            ...
                            if operators.takes_two_argument(element):
                                ...
                                try:
                                    ...
                                    pass
                                value = Interactor.open_display_list_of_actions.execute(element, *args, shift_a=shift_a, shift_b=shift_b)
                                stack.append(value)
                            elif operators.takes_one_argument(element):
                                op = stack.pop()
                                args = (period, op)
                                value = Interactor.open_display_list_of_actions.execute(element, *args)
                                stack.append(value)
                            else:
                                try:
                                ...
                                if two_forward == element:
                                    ...
                                    # Calculate
                                    args = op1 + (op2,)
                                    value = Interactor.open_display_list_of_actions.execute(element, period, *args)
                                    stack.append(value)
                        else:
                    ...
                    if len(stack) != 1:
                        ...
                        args = (stack.pop(), 1)
                        value = Interactor.open_display_list_of_actions.execute('*', period, *args)
